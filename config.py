...
class Config(object):
    ...
    #tg bot token
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7439562089:AAGYUhOKKL18EDCrKqzZadf2sXk1G6ZwlXg")
    ...
    PROXY = os.environ.get("PROXY", "http://paypalmafiabots:QD4n9eB7gf@103.235.64.29:50100")
